...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var defaultViewController : UIViewController? {
        let isLogin = CZUserAccountViewModel.shareInstance.isLogin
        return isLogin ? CZWelcomeViewController() : UIStoryboard(name: "Main", bundle: nil).instantiateInitialViewController()
    }
